...
var showAlert = exports.showAlert = function showAlert(type, msg) {
  ...
  // afterbegin  is right at beginning
...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  // map actually fit the bounds
  // also specifying the  padding to the bounds
...
/* eslint-disable */
// getting the data from the user interface  and then delegating some actions into these other modules
// include to polyfill some of the features of javascript
...
// then to get access to the location data of the tour tp display right here in javascript file
